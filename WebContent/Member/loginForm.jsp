...
<body>
<form name = "loginform" action = "../MemberLoginAction.me" method = "post" class = "signUp" id = "signupForm">
	<h1 class = "signUpTitle">로그인</h1>
	<input type="text" class="signUpInput"  name = "member_id" placeholder="Type your username" autofocus required>
   <input type="password" class="signUpInput"  name = "member_pw" placeholder="Choose a password" required>
   <input type= "submit" value="로그인" class="signUpButton">&nbsp;
   &nbsp;
   <input type = "button" onclick = "location.href='../MemberJoin.me'" value = "회원가입" class = "signUpButton">
</form>
</body>
</html>